...
class AdaptiveRotatedConv2d(nn.Module):
    ...
    def __init__(self, in_channels, in_channels1,out_channels, kernel_size,
    ...
    def forward(self, x, x_e):
        ...
        rotated_weight_x_e = self.rotate_func(self.weight + self.weight1, alphas + alphas_e, angles_e)

...
# from .model_oft_relation_both_free_half import build_model
# from .model_naclip import build_model
...
_MODELS = {
    ...
    "ViT-B/16": os.path.join(os.path.dirname(__file__), "ViT-B-16.pt"),

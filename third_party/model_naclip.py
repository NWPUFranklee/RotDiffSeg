...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, dense=True, return_all=False):
        B, nc, w, h = x.shape
...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, dense=True, return_all=False):
        return self.visual(image.type(self.dtype), dense=dense,return_all=return_all)
